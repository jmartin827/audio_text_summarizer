...
An audio file is uploaded to Fast API along with desired summarization ratio and
a UUID for the file is returned which is used for later reference.
...
This is a work in progress--but the baseline functionality is there.